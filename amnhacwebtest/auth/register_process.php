...
function show_message($title, $message, $is_error = true) {
    ...
    <body>
        <div class="container">
            ...
            <div class="btn-group">
                <a href="login_form.php" class="btn btn-primary">Quay lại Đăng nhập</a>
...
if ($username === '' || $password === '' || $confirm_password === '') {
    show_message("Thiếu thông tin", "Vui lòng nhập đầy đủ tất cả các trường thông tin yêu cầu.");
}

if ($password !== $confirm_password) {
    show_message("Lỗi xác nhận", "Mật khẩu xác nhận không khớp. Vui lòng kiểm tra lại.");
}
...
if ($result->num_rows > 0) {
    show_message("Tài khoản đã tồn tại", "Tên tài khoản '<strong>$username</strong>' đã được sử dụng. Vui lòng chọn tên khác.");
}
...
if ($insertStmt->execute()) {
    ...
    show_message("Đăng ký thất bại", "Đã có lỗi xảy ra trong quá trình đăng ký. Vui lòng thử lại sau.");
}
