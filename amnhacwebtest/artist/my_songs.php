...
<head>
    ...
    <style>
        ...
        tr:hover td { background-color: var(--nav-hover); }

        .cover-img { width: 48px; height: 48px; border-radius: 4px; object-fit: cover; }
        ...
        .btn-del { color: var(--logout-red); text-decoration: none; font-size: 0.9rem; }
        .btn-del:hover { text-decoration: underline; }
        
        .btn-send { color: var(--spotify-green); text-decoration: none; font-size: 0.9rem; font-weight: bold; }
        .btn-send:hover { text-decoration: underline; }

        audio { height: 32px; filter: invert(100%) hue-rotate(180deg) brightness(1.5); opacity: 0.8; width: 200px; }
    </style>
</head>
<body>
